...
<title>List Student Classes</title>
<h3><center> List Student Classes </center></h3>
...
{
alert("PLease provide the student B_NUMBER");
form1.bNumber.focus();
return false;
}
}
...
<%-- Passing the hidden variable , value is : 'listStudentClasses' --%> 
<tr><td><input type="hidden" name="selectedPage" value="listStudentClasses" /></td></tr>
</table>
</fieldset>
</form>
</body>
